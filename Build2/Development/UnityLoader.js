...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Build2.data';
    var REMOTE_PACKAGE_BASE = 'Build2.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3242609;
      var PACKAGE_UUID = '89761cdc-748a-496b-bcca-0667809ee185';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 417381, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(417381, 417402, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(417402, 422816, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(422816, 2340012, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2340012, 3214984, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3214984, 3242609, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Build2.data');

    };
    Module['addRunDependency']('datafile_Build2.data');
